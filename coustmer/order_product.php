...
?>
				...
				<form  method="post" role="form">   
					...
					<div  class="form-group">
                      ...
                      <input name="or_q" type="text" class="form-control" placeholder="Enter ...">
                    </div>
...
$querys = mysql_query("insert into or_t(customer_id,product_id,or_q) 
                      values('$customer_id','$product_id','$or_q')");
					
					  
		//$up = mysql_query("UPDATE product SET where more ="".$row['more']+1." AND quantety =".$row['quantety']-$_POST[pro_quantety]." where id =$id); 
		
					  
//if(isset($querys)){echo "insert is done";}else{echo "insert not done";} 
