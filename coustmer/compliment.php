...
$query=mysql_query("insert into complaints(subject,full_name,massage) 
values('$subject','$full_name','$massage')");
}
?>
		 ...
		 <div class="box box-warning">
                ...
                <div class="box-body">
                  <form role="form" action="compliment.php" method="post">
                    <!-- text input -->
                    <div class="form-group">
                      <label>subject</label>
                      <input name="subject" type="text" class="form-control" placeholder="Enter ...">
                    </div>
                    <div class="form-group">
