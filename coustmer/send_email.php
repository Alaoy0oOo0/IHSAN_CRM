...
if(isset($_POST['add']))
{
$em_from=@$_POST['em_from'];
$em_to=@$_POST['em_to'];
$em_subject=@$_POST['em_subject'];
$em_massage=@$_POST['em_massage'];

$query=mysql_query("insert into em(em_from,em_to,em_subject,em_massage) 
values('$em_from','$em_to','$em_subject','$em_massage')");
}
?>
                ...
                <div class="box-body">
                  <form role="form"  method="post">
                    ...
                    <div class="form-group">
                      <label>from:</label>
                      <input name="em_from" type="text" class="form-control" placeholder="Enter ...">
                    </div>
					<div class="form-group">
                      <label>to:</label>
                      <input name="em_to" type="text" class="form-control" placeholder="Enter ...">
                    </div>
                    <div class="form-group">
                      <label>subject</label>
                      <input name="em_subject" type="text" class="form-control" placeholder="Enter ...">
                    </div>
                    
                    <!-- textarea -->
                    <div class="form-group">
                      <label>massage</label>
                      <textarea name="em_massage" class="form-control" rows="3" placeholder="Enter ..."></textarea>
                    </div>
