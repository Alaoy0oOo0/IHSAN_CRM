...
$query=mysql_query("select * from customer where customer_id=$customer_id")
or die (mysql_error());
...
$update=mysql_query("update customer set customer_name='$customer_name',user_name='$user_name',password='$password' where customer_id=$customer_id");
header('location:show_coustmer.php');
					exit();
}
?>   

        <form action="update_coustmer.php?customer_id=<?php echo $customer_id; ?>" method="post">
          <div class="form-group has-feedback">
            <input name="customer_name" type="text" value="<?php echo $row['customer_name'];?>" class="form-control" placeholder="الاسم كامل">
