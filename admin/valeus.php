...
$query=mysql_query("insert into report(january,february,march,pro_name) 
values('$january','$february','$march','$pro_name')");
}
?>
   
                <form action="valeus.php" method="post" role="form">
                  <div class="box-body">
                    <div class="form-group">
                      <label>اسم المنتج</label>
                      <input name="pro_name"  type="text" class="form-control" placeholder="Enter ..." autocomplete="on">
                    </div>
					<div class="form-group">
                      <label>اسم المنتج</label>
                      <input name="january"  type="text" class="form-control" placeholder="Enter ..." autocomplete="on">
                    </div>
                    <div class="form-group">
                      <label>الباركود</label>
                      <input name="february"  type="text" class="form-control" placeholder="Enter ...">
                    </div>
                    <div class="form-group">
                      <label>الشركة المصنعة</label>
                      <input name="march"  type="text" class="form-control" placeholder="Enter ...">
                    </div>
