            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">User Database Table</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
<?php
include"connect.php";
                  ...
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><a href="update_user.php?user_id=<?php echo $row ['user_id']; ?>">UPDATE</a></td>
                    ...
                    <tfoot>
                      <tr>
                        ...
                        <th>..</th>
                        <div align="right">
                         <button class="btn btn-block btn-default"><a href="add_user.php">اضافة مستخدم جديد</a></button>
                        </div>
                      </tr>
                    </tfoot>
                  </table>
