...
$customer_addrees=@$_POST['customer_addrees'];
$customer_phone	=@$_POST['customer_phone'];
$customer_mobile=@$_POST['customer_mobile'];
$user_name=@$_POST['user_name'];
$password	=@$_POST['password'];

$query=mysql_query("insert into customer(customer_name,customer_addrees,customer_phone,customer_mobile,user_name,password) 
values('$customer_name','$customer_addrees','$customer_phone','$customer_mobile','$user_name','$password')");
}
?>
  <body class="hold-transition register-page" >
    <div class="register-box">
      ...
      <div class="register-box-body">
        <p class="login-box-msg">ADD NEW COUSTMER</p>
        <form action="" method="post">
          ...
          <div class="form-group has-feedback">
            <input name="customer_addrees" type="text" class="form-control" placeholder="Address">
            <span class="glyphicon glyphicon-home form-control-feedback"></span>
          </div>
		  <div class="form-group has-feedback">
            <input name="customer_phone" type="text" class="form-control" placeholder="Telephone">
            <span class="glyphicon glyphicon-phone-alt form-control-feedback"></span>
          </div><div class="form-group has-feedback">
            <input name="customer_mobile" type="text" class="form-control" placeholder="Mobaile">
