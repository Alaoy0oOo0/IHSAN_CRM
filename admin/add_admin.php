...
$query=mysql_query("insert into admin(user_name,password) 
  ...
  <body class="hold-transition register-page" >
    <div class="register-box">
      ...
      <div class="register-box-body">
        <p class="login-box-msg">ADD NEW ADMIN</p>
        <form action="" method="post">
          ...
          <div class="row">
            ...
            <div class="col-xs-4">
              <button type="submit" value="add" class="btn btn-primary btn-block btn-flat">add</button>
