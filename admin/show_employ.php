                  ...
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><a href="update_employ.php?employ_id=<?php echo $row ['employ_id']; ?>">UPDATE</a></td>
                        <td><a href="delete_employ.php?employ_id=<?php echo $row ['employ_id']; ?>">DELETE</a></td>
                      </tr>
                      <?php }?>
                    ...
                    <tfoot>
                      <tr>
                        ...
                        <th>..</th>
                        <div align="right">
                         <button class="btn btn-block btn-default"><a href="add_employ.php">add new employee</a></button>
                        </div>
                      </tr>
                    </tfoot>
                  </table>
