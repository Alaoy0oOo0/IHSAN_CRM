      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <!-- Your Page Content Here -->
           <?php
include"connect.php";
if(isset($_POST['employ_name']))
{
$employ_name=@$_POST['employ_name'];
$employ_address=@$_POST['employ_address'];
$employ_phone=@$_POST['employ_phone'];
$employ_mobile=@$_POST['employ_mobile'];
$user_name	=@$_POST['user_name'];
$password=@$_POST['password'];

$query=mysql_query("insert into employ(employ_name,employ_address,employ_phone,employ_mobile,user_name,password) 
values('$employ_name','$employ_address','$employ_phone','$employ_mobile','$user_name','$password')");
}
?>
  <body class="hold-transition register-page">
    <div class="register-box">
      <div class="register-logo">
        <a href="#"><b>IHSAN</b>CRM</a>
      </div>

      <div class="register-box-body">
        <p class="login-box-msg">ADD NEW EMPLOYEE</p>
        <form action="" method="post">
          <div class="form-group has-feedback">
            <input name="employ_name" type="text" class="form-control" placeholder="Full Name">
            <span class="glyphicon glyphicon-pencil form-control-feedback"></span>
          </div>
		  <div class="form-group has-feedback">
            <input name="employ_address" type="text" class="form-control" placeholder="address">
            <span class="glyphicon glyphicon-home form-control-feedback"></span>
          </div>
		  <div class="form-group has-feedback">
            <input name="employ_phone" type="text" class="form-control" placeholder="Telephone">
            <span class="glyphicon glyphicon-phone-alt form-control-feedback"></span>
          </div>
          <div class="form-group has-feedback">
            <input name="employ_mobile" type="text" class="form-control" placeholder="Mobile">
          ...
          <div class="row">
            ...
            <div class="col-xs-4">
              <button type="submit" name="add" value="add" class="btn btn-primary btn-block btn-flat">Add</button>
