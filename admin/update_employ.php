...
$query=mysql_query("select * from employ where employ_id=$employ_id")
or die (mysql_error());
...
$update=mysql_query("update employ set employ_name='$employ_name',user_name='$user_name',password='$password' where employ_id=$employ_id");
header('location:show_employ.php');
					exit();
}
?>   

        <form action="update_employ.php?employ_id=<?php echo $employ_id; ?>" method="post">
          <div class="form-group has-feedback">
            <input name="employ_name" type="text" value="<?php echo $row['employ_name'];?>" class="form-control" placeholder="الاسم كامل">
