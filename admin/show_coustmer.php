                  ...
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><a href="update_coustmer.php?customer_id=<?php echo $row ['customer_id']; ?>">UPDATE</a></td>
                        <td><a href="delete_coustmer.php?customer_id=<?php echo $row ['customer_id']; ?>">DELETE</a></td>
                      </tr>
                      <?php }?>
                    ...
                    <tfoot>
                      <tr>
                        ...
                        <th>..</th>
                        <div align="right">
                         <button class="btn btn-block btn-default"><a href="add_customer.php">add new coustmer</a></button>
                        </div>
                      </tr>
                    </tfoot>
                  </table>
