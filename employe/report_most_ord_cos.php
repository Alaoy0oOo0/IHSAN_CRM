...
<html>
  ...
  $query=mysql_query("SELECT customer_id,SUM(or_q) FROM or_t GROUP BY customer_id ORDER BY SUM(or_q) DESC")
or die (mysql_error());
  ...
  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><?php $dptid1= $row['customer_id']; 
			 	include "connect.php";
  				$query7 = mysql_query("select * from customer where customer_id=$dptid1")or die(mysql_error());
   				$row7 = mysql_fetch_assoc($query7);
			 	echo $row7['customer_name'];?></td>
						<td><?php echo $row['SUM(or_q)'];?></td>
