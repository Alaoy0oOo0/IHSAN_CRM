...
$query=mysql_query("insert into offer(offer_name,offer_type,offer_start,offer_end,descrption) 
values('$offer_name','$offer_type','$offer_start','$offer_end','descrption')");
                ...
                <form action="" method="post" role="form">
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <input name="offer_name" type="text" class="form-control" placeholder="Enter ..." autocomplete="on">
                    </div>
                  ...
                  <div class="input-group">
                      ...
                      <input name="offer_start" type="date" class="form-control" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask="">
                    </div>
                    <label>end to</label>
                    <div class="input-group">
                      <div class="input-group-addon">
                      ...
                      <input name="offer_end" type="date" class="form-control" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask="">
                    </div>
                    <div class="form-group">
                      <label>descrption</label>
                      <textarea name="descrption" class="form-control" rows="3" placeholder="Enter ..."></textarea>
                    </div>
