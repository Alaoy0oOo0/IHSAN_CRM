...
<?php
include"connect.php";
$query=mysql_query("select * from offer")
or die (mysql_error());
?>
  ...
  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><a href="offer_update.php?offer_id=<?php echo $row ['offer_id']; ?>">UPDATE</a></td>
                        <td><a href="delete_offer.php?offer_id=<?php echo $row ['offer_id']; ?>">DELETE</a></td>
                      </tr>
                      <?php }?>
                    ...
                    <tfoot>
                      <tr>
                        ...
                        <th>..</th>
                        <div align="right">
                         <button class="btn btn-block btn-default"><a href="add_offer.php">Add new offer</a></button>
                        </div>
                      </tr>
                    </tfoot>
                  </table>
