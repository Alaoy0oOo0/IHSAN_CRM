...
// check if the user exist in database
		$stmt = $db->prepare("select  * FROM   employ WHERE user_name = ? AND user_password= ?  ");
		...
		if($count > 0)
		  { 
				  ...
				  header('location:http://localhost:8080/IHSAN_CRM/main_page_e.php');
				  exit();
  ...
  <body class="hold-transition login-page" dir="rtl">
    <div class="login-box">
      <div class="login-logo">
        <a href="http://localhost:8080/IHSAN_CRM/main_page_e.php"><b>IHSAN</b>CRM</a>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
        <p class="login-box-msg">سجل دخولك لتبداء الجلسه</p>
        <form action="http://localhost:8080/IHSAN_CRM/main_page_e.php" method="post">
          ...
          <div class="row">
            ...
            <div class="col-xs-4">
              <button action="http://localhost:8080/IHSAN_CRM/main_page_e.php" type="submit" class="btn btn-primary btn-block btn-flat">تسجيل الدخول</button>
            </div><!-- /.col -->
          </div>
        </form>
